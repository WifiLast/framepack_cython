...
This is a quick and dirty UI update and translation for FramePack-eichi.
Install FramePack from [lllyasviel/FramePack](https://github.com/lllyasviel/FramePack). Make sure the original version works as intended, then add these files to the base directory and run run_endframe_ichi.bat.
